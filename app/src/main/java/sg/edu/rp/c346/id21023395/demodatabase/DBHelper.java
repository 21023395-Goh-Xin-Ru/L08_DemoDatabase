...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<String> getTaskContent() {
        ...
        // Cursor - it is a temporary table to store records that were just retrieved
    ...
    public ArrayList<Task> getTasks(boolean isAscending) {
        ...
        Cursor cursor = db.query(TABLE_TASK, columns, null, null, null, null, COLUMN_DESCRIPTION + " " + sortOrder, null);
